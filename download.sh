...
wget http://svl.stanford.edu/scene-graph/dataset/mini-vg.zip
unzip mini-vg.zip
mv vg data/
rm mini-vg.zip

echo 'Downloading the final model checkpoint...'
wget http://svl.stanford.edu/scene-graph/checkpoints/dual_graph_vrd_final_iter2_checkpoint.zip
